// ==UserScript==
// @name            AdSense for Wikipedia
// @namespace       http://full-speed.org/files
// @description     Proof of Concept for displaying AdSense ads on wikipedia via GreaseMonkey
...
function G(b,a,d){
 ...
 d=d.replace(/%\w?$/,"");
 el = a.getElementById('siteNotice');
 if (!el) {return false;}
 el.innerHTML = '<div style="text-align:right"><iframe name="google_ads_frame" width='+m(b.google_ad_width)+" height="+m(b.google_ad_height)+" frameborder="+m(b.google_ad_frameborder)+" src="+m(d)+' marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no"></iframe></div>';
}
function F(b){
 var a=null;
...
function A(){
 ...
 if(q){
  ...
  if(a.google_num_0ad_slots>3){return}
  ...
  if(a.google_num_slots_to_rotate){
   ...
   if(a.google_num_slot_to_show!=a.google_num_ad_slots){return}
  }else if(a.google_num_ad_slots>3&&h==""){return}
 }
 c("dt",g.getTime());
 ...
 if(a.google_ad_channel){
  var r=a.google_ad_channel.toLowerCase();
  f("channel",r);
  var s="",t=r.split("+");
...
function x(b,a){
 ...
 if(b.google_ad_width&&b.google_ad_height){
  ...
  if(e>2*b.google_ad_height||g>2*b.google_ad_width){return false}
 }
 return true
}
function E(){
 var b=window,a=document,d=a.location,g=a.referrer,e=null;
if (!a.location) {alert('document not avail');return false}
 b.google_ad_client = "ca-test";
 b.google_ad_width = 468;
 b.google_ad_height = 60;
 b.google_ad_format = "468x60_as";
 b.google_ad_type = "text_image";
 b.google_ad_channel = "";
 b.google_color_border = "CCCCCC";
 b.google_color_bg = "FFFFFF";
 b.google_color_link = "000000";
 b.google_color_text = "333333";
 b.google_color_url = "666666";
